...
| `rails.md` | Working in Ruby/Rails/Minitest -- assertion patterns, fixtures, `travel_to`/WebMock, ActiveRecord and interactor characterisation |
...
- Migrating tests between frameworks -- characterise behavior first, then rewrite the tests against the pins
