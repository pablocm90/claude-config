...
| `rails.md` | Working in Ruby/Rails -- constructor injection, extract and override, `class_attribute`, prepend, duck-typed fakes |
...
- Code sends emails, enqueues background jobs, or calls external APIs inline
